...
checkout article published for zenn.
...
class ZennCheckout(CommonCheckout):
    r"""
    checkout article published for zenn.
    """
...
def main():
    ...
    print(args)
    ZennCheckout(dry_run=args.dry).checkout(args.key)
