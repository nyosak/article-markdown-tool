...
publish current article file for zenn.
...
class ZennPublish(CommonPublish):
    r"""
    publish current article file for zenn.
    """
    ...
    def git(self):
        ...
        if self._git is None:
            ...
            self._git = ZennGit(skip_initialize=True)
        return self._git
...
def main():
    ...
    description = 'publish current article file for zenn.'
    ...
    print(args)
    ZennPublish(dry_run=args.dry, no_merge=args.nomerge, ignore_uncommitted_change=args.ignore).publish()
